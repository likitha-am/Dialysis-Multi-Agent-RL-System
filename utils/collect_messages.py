...
def collect():
    ...
    # ⚠️ load trained weights if saved (optional)
    # pre_agent.load_state_dict(torch.load("pre.pth"))
    ...
    for episode in range(20):
        ...
        for step in range(5):
            ...
            # Store messages
            messages.append(m1.detach())
            messages.append(m2.detach())
            messages.append(m3.detach())

            state, _ = env.step(a_pre, a_intra, a_post)
    ...
    print("Saved messages:", messages.shape)
